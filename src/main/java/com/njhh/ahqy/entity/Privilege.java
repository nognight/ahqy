...
public class Privilege {
    ...
    private Integer type;//权益类型  1是订购送  2是打折  3领取可用卡券  4领取未激活券
    private Integer category;//种类，即类型的子分类  1视频 2音乐，3阅读 4游戏 5首月免
    ...
    private Integer giftType;//礼物类型 -1是无礼物赠送  1是卡券，2是激活卡券 3是产品
