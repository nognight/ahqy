...
public interface PrivilegeService {
     ...
     * @return
     */
    List<Privilege> getPrivilegeList(int type, int category, int giftType, HttpSession httpSession);
     ...
     * @return
     */
    Privilege getPrivilegeName(int id, HttpSession httpSession);

    /**
     * @param httpSession
     * @return
     */
    List<UserPrivilege> getUserPrivilegeList(HttpSession httpSession, int type);
